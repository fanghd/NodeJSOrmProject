...
--
-- Host: localhost    Database: db_todo_web
-- ------------------------------------------------------
...
--
-- Table structure for table `t_todo_files`
--

DROP TABLE IF EXISTS `t_todo_files`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `t_todo_files` (
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=gbk COMMENT='接口测试todo文件表';
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
